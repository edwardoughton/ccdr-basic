...
plot1 = ggplot(data_aggregated, 
  ...
  labs(colour=NULL,
       title = "Estimated Riverine Flooding Direct Damage Cost to Fiber Networks in DRC",
...
max_y_value = max(data_aggregated$fiber_at_risk_perc_max, na.rm = TRUE)
 ...
 plot1 = 
  ...
  theme(legend.position = 'bottom',
        axis.text.x = element_text(angle=45, hjust=1)) +
  labs(colour=NULL,
       title = "Estimated Riverine Flooding Damage to Fiber Networks in DRC",
       subtitle = "Reported by Annual Probability and Climate Scenario for 2080.", 
...
plot1 = ggplot(data_aggregated, 
  ...
  theme(legend.position = 'bottom',
        axis.text.x = element_text(angle=45, hjust=1)) +
  labs(colour=NULL,
       title = "Estimated Riverine Flooding Direct Damage Cost to Mobile Cells in DRC",
       subtitle = "Reported by Annual Probability and Climate Scenario for 2080.", 
...
plot1 = 
  ...
  theme(legend.position = 'bottom',
        axis.text.x = element_text(angle=45, hjust=1)) +
  labs(colour=NULL,
       title = "Estimated Riverine Flooding Damage to Mobile Cells in DRC",
       subtitle = "Reported by Annual Probability and Climate Scenario for 2080.", 
...
#         axis.text.x = element_text(angle=45, hjust=1)) +
#   labs(colour=NULL,
#        title = "Estimated Riverine Flooding Direct Damage Cost to Roads in DRC",
#        subtitle = "Reported by Annual Probability and Climate Scenario for 2080.", 
#        x = "Annual Probability of Occurance (%)", y = "Direct Damage (US$ Millions)", 
#        fill="Climate Scenario") +
#   theme(panel.spacing = unit(0.6, "lines")) + 
...
#         axis.text.x = element_text(angle=45, hjust=1)) +
#   labs(colour=NULL,
#        title = "Estimated Riverine Flooding Damage to Roads in DRC",
#        subtitle = "Reported by Annual Probability and Climate Scenario for 2080.", 
