...
plot1 = ggplot(data_aggregated, 
  ...
  labs(colour=NULL,
       title = "Estimated Riverine Flooding Direct Damage Cost to Fiber Networks in Madagascar",
...
plot1 = 
  ...
  theme(legend.position = 'bottom',
        ...
        text = element_text(size = 12)) +
  labs(colour=NULL,
       title = "Estimated Riverine Flooding Damage to Fiber Networks in Madagascar",
       subtitle = "Reported by Annual Probability and Climate Scenario for 2080.", 
...
plot1 = ggplot(data_aggregated, 
  ...
  theme(legend.position = 'bottom',
        ...
        text = element_text(size = 12)) +
  labs(colour=NULL,
       title = "Estimated Riverine Flooding Direct Damage Cost to Mobile Cells in Madagascar",
       subtitle = "Reported by Annual Probability and Climate Scenario for 2080.", 
       x = "Annual Probability of Occurance (%)", y = "Direct Damage (US$ Millions)", 
       fill="Climate Scenario") +
  theme(panel.spacing = unit(0.6, "lines")) + 
...
plot1 = 
  ...
  theme(legend.position = 'bottom',
        ...
        text = element_text(size = 12)) +
  labs(colour=NULL,
       title = "Estimated Riverine Flooding Damage to Mobile Cells in Madagascar",
       subtitle = "Reported by Annual Probability and Climate Scenario for 2080.", 
...
plot1 = ggplot(data, aes(x=risk_cat, y=perc, fill=risk_cat)) + 
  ...
  labs(colour=NULL,
       title = "Estimated Landslide Exposure for Mobile Cells and Fiber Assets in Madagascar",
...
path = file.path(folder, 'figures', iso3, 'MDG_landslide_risk_relative.png')
...
plot2 = 
  ...
  labs(colour=NULL,
       title = "(A) Mobile Cell Exposure in Madagascar",
       subtitle = "Reported by Landslide Risk Category.", 
...
plot3 = 
  ...
  theme(legend.position = '',
        ...
        text = element_text(size = 10)) +
  labs(colour=NULL,
       title = "(B) Fiber Exposure in Madagascar",
       subtitle = "Reported by Landslide Risk Category.", 
...
path = file.path(folder, 'figures', iso3, 'MDG_landslide_risk_absolute.png')
ggsave(path, units="in", width=8, height=4, dpi=300)
