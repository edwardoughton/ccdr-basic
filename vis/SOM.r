...
plot1 = ggplot(data_aggregated, 
  ...
  labs(colour=NULL,
       title = "Estimated Riverine Flooding Direct Damage Cost to Fiber Networks in Somalia",
...
plot1 = 
  ...
  theme(legend.position = 'bottom',
        axis.text.x = element_text(angle=45, hjust=1)) +
  labs(colour=NULL,
       title = "Estimated Riverine Flooding Damage to Fiber Networks in Somalia",
       subtitle = "Reported by Annual Probability and Climate Scenario for 2080.", 
...
plot1 = ggplot(data_aggregated, 
  ...
  theme(legend.position = 'bottom',
        axis.text.x = element_text(angle=45, hjust=1)) +
  labs(colour=NULL,
       title = "Estimated Riverine Flooding Direct Damage Cost to Mobile Cells in Somalia",
       subtitle = "Reported by Annual Probability and Climate Scenario for 2080.", 
       x = "Annual Probability of Occurance (%)", y = "Direct Damage (US$ Millions)", 
       fill="Climate Scenario") +
  theme(panel.spacing = unit(0.6, "lines")) + 
...
plot1 = 
  ...
  theme(legend.position = 'bottom',
        axis.text.x = element_text(angle=45, hjust=1)) +
  labs(colour=NULL,
       title = "Estimated Riverine Flooding Damage to Mobile Cells in Somalia",
       subtitle = "Reported by Annual Probability and Climate Scenario for 2080.", 
...
plot1 = ggplot(data, aes(x=risk_cat, y=perc, fill=risk_cat)) + 
  ...
  theme(legend.position = '',
        axis.text.x = element_text(angle=45, hjust=1)) +
  labs(colour=NULL,
       title = "Estimated Landslide Exposure for Mobile Cells and Fiber Assets in Somalia",
...
plot2 = 
  ...
  theme(legend.position = '',
        axis.text.x = element_text(angle=45, hjust=1)) +
  labs(colour=NULL,
       title = "(A) Mobile Cell Exposure in Somalia",
       subtitle = "Reported by Landslide Risk Category.", 
...
plot3 = 
  ...
  theme(legend.position = '',
        axis.text.x = element_text(angle=45, hjust=1)) +
  labs(colour=NULL,
       title = "(B) Fiber Exposure in Somalia",
       subtitle = "Reported by Landslide Risk Category.", 
