...
plot1 = ggplot(data_aggregated, 
  ...
  labs(colour=NULL,
       title = "Estimated Riverine Flooding Direct Damage Cost to Fiber Networks in South Sudan",
...
plot1 = 
  ...
  geom_errorbar(data=data_aggregated, aes(
    ...
    lwd = 0.2,
    show.legend = FALSE, width=0.1,  color="#FF0000FF") +
  geom_text(aes(label = paste(round(fiber_at_risk_perc_mean,1),"")), size = 3,
            position = position_dodge(1), vjust =-.5, hjust =-.2, angle = 90)+
  theme(legend.position = 'bottom',
        axis.text.x = element_text(angle=0, hjust=1, size = 12),
        axis.text.y = element_text(angle=0, hjust=1, size = 12),
        text = element_text(size = 12)) +
  labs(colour=NULL,
       title = "Estimated Riverine Flooding Damage to Fiber Networks in South Sudan",
       subtitle = "Reported by Annual Probability and Climate Scenario for 2080.", 
...
plot1 = ggplot(data_aggregated, 
  ...
  theme(legend.position = 'bottom',
        ...
        text = element_text(size = 12)) +
  labs(colour=NULL,
       title = "Estimated Riverine Flooding Direct Damage Cost to Mobile Cells in South Sudan",
       subtitle = "Reported by Annual Probability and Climate Scenario for 2080.", 
       x = "Annual Probability of Occurance (%)", y = "Direct Damage (US$ Millions)", 
       fill="Climate Scenario") +
  theme(panel.spacing = unit(0.6, "lines")) + 
...
plot1 = 
  ...
  geom_errorbar(data=data_aggregated, aes(
    ...
    lwd = 0.2,
    show.legend = FALSE, width=0.1,  color="#FF0000FF") +
  geom_text(aes(label = paste(round(cells_at_risk_perc_mean,1),"")), size = 3,
            position = position_dodge(1), vjust =-.6, hjust =-.2, angle = 90)+
  theme(legend.position = 'bottom',
        axis.text.x = element_text(angle=0, hjust=1, size = 12),
        axis.text.y = element_text(angle=0, hjust=1, size = 12),
        text = element_text(size = 12)) +
  labs(colour=NULL,
       title = "Estimated Riverine Flooding Damage to Mobile Cells in South Sudan",
       subtitle = "Reported by Annual Probability and Climate Scenario for 2080.", 
...
plot1 = ggplot(data, aes(x=risk_cat, y=perc, fill=risk_cat)) + 
  ...
  labs(colour=NULL,
       title = "Estimated Landslide Exposure for Mobile Cells and Fiber Assets in South Sudan",
...
path = file.path(folder, 'figures', iso3, 'SOM_landslide_risk_relative.png')
...
plot2 = 
  ...
  labs(colour=NULL,
       title = "(A) Mobile Cell Exposure in South Sudan",
       subtitle = "Reported by Landslide Risk Category.", 
...
plot3 = 
  ...
  theme(legend.position = '',
        ...
        text = element_text(size = 10)) +
  labs(colour=NULL,
       title = "(B) Fiber Exposure in South Sudan",
       subtitle = "Reported by Landslide Risk Category.", 
...
path = file.path(folder, 'figures', iso3, 'SOM_landslide_risk_absolute.png')
ggsave(path, units="in", width=8, height=4, dpi=300)
