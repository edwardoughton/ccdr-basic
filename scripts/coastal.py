...
if __name__ == '__main__':
    ...
    for idx, country in countries.iterrows():
        ...
        process_inuncoast(country, scenarios, return_periods)

        print('extracting coastal')
        extract_inuncoast(country, scenarios, return_periods)
        ...
        # # plot_inuncoast_uncovered(country, outline, dimensions, scenarios, models, return_periods)
